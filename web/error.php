...
$_err = [
    ...
    '50x' => [
        'title' => 'The page is temporarily unavailable. Try again later.',
...
<head>
    ...
    <title>We've got some trouble | <?php echo nl2br(htmlspecialchars($error)); ?> - <?php echo nl2br(htmlspecialchars($errorInfo['title'])); ?></title>
...
<div class="cover">
    <h1><?php echo nl2br(htmlspecialchars($errorInfo['title'])); ?>
        <small>Error <?php echo $error; ?></small>
    </h1>
    <p class="lead"><?php echo nl2br(htmlspecialchars($errorInfo['message'])); ?></p>
</div>
